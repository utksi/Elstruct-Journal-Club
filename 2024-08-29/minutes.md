...
### 1. Electronic-structure methods for materials design [[Read](https://www.nature.com/articles/s41563-021-01013c-3)]
   ...
   **Abstract** - The accuracy and efficiency of electronic-structure methods to understand, predict and design the properties of materials has driven a new paradigm in research.
   <details>
...
### 2. Phonon-induced renormalization of exchange interactions in metallic two-dimensional magnets [[Read](https://arxiv.org/abs/2406.05229)]
   ...
   **Abstract** - The presence of spin-polarized charge carriers in metallic magnets provides a mechanism for spin-lattice interactions mediated by electron-phonon coupling.
   <details>
   <summary>See More...</summary>
...
### 3. Ephemeral data derived potentials for random structure search [[Read](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.106.014102)]
   ...
   **Abstract** - Structure prediction has become a key task of the modern atomistic sciences and depends on the rapid and reliable computation of energy landscapes. 
   <details>
   <summary>See More...</summary>
...
### 4. Anomalies in particle physics and their implications for physics beyond the standard model [[Read](https://www.nature.com/articles/s42254-024-00703-6)]
   ...
   **Abstract** - The standard model (SM) of particle physics is the mathematical description of the fundamental constituents and interactions of matter. 
   <details>
   <summary>See More...</summary>
...
### 5.  Dark states of electrons in a quantum system with two pairs of sublattices [[Read](https://www.nature.com/articles/s41567-024-02586-x)]
   ...
   **Abstract** - A quantum state of matter that is forbidden to interact with photons and is therefore undetectable by spectroscopic means is called a dark state. 
   <details>
   <summary>See More...</summary>
...
### 6. Coherent Acoustic Control of Defect Orbital States in the Strong-Driving Limit [[Read](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030336)]
   ...
   **Abstract** - We use a bulk acoustic wave resonator to demonstrate coherent control of the excited orbital states in a diamond nitrogen-vacancy (NV) center at cryogenic temperature. 
   <details>
   <summary>See More...</summary>
...
### 7. Improving equations of state calibrations in the toroidal DAC—The case study of molybdenum [[Read](https://doi.org/10.1063/5.0223794)]
   ...
   **Abstract** - We report an updated isothermal equation of state (EoS) of molybdenum (Mo) obtained by compression in beveled and toroidal diamond-anvil cells (DACs). 
   <details>
   <summary>See More...</summary>
